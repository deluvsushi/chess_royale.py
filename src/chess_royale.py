...
class ChessRoyale:
	...
	def login_with_auth_token(self, auth_token: str):
	...
	def get_current_olympiads(self):
		return requests.get(
			f"{self.first_api}/olympiads/current",
			headers=self.headers).json()


	def get_previous_olympiads(self):
		return requests.get(
	...
	def get_current_daily_mission(self):
		return requests.get(
	...
	def get_storm_leaderboard(self):
		return requests.get(
			f"{self.first_api}/storm/leaderboard/count",
			headers=self.headers).json()

	def get_today_storm_leaderboard(self):
		return requests.get(
			f"{self.first_api}/storm/leaderboard/count/today",
			headers=self.headers).json()

	def get_series_storm_leaderboard(self):
		return requests.get(
			f"{self.first_api}/storm/leaderboard/count/series",
			headers=self.headers).json()

	def get_puzzles_leaderboard(self, type: str = "world"):
		return requests.get(
	...
	def change_flag(self, flag_icon: int):
		data = {"flagIcon": flag_icon}
		return requests.put(
	...
	def get_coin_reward(self, reward_number: int):
	...
	def get_shop_coins(self):
		return requests.get(
			f"{self.first_api}/shop/coins",
			headers=self.headers).json()
			
	def get_shop_hints(self):
		return requests.get(
			f"{self.first_api}/shop/hints",
			headers=self.headers).json()

	def get_shop_avatars(self):
		return requests.get(
			f"{self.first_api}/shop/avatars",
			headers=self.headers).json()
	
	def get_shop_phrases(self):
		return requests.get(
			f"{self.first_api}/shop/hints/phrases",
			headers=self.headers).json()
	
	def get_shop_emoticons(self):
		return requests.get(
	...
	def get_shop_boards(self):
		return requests.get(
			f"{self.first_api}/shop/boards",
			headers=self.headers).json()
	
	def get_shop_safes(self):
		return requests.get(
			f"{self.first_api}/shop/safes",
			headers=self.headers).json()
	
	def get_shop_passes(self):
		return requests.get(
			f"{self.first_api}/shop/passes",
			headers=self.headers).json()
	

	def buy_item(self, category: str, item_id: str):
		return requests.post(
			f"{self.first_api}/shop/{category}/{item_id}",
			headers=self.headers).json()

	def claim_achievement(self, type: str, degree: int):
		data = {
			"type": type,
			"degree": degree
		}
	...
	def change_image_url(self, image_url: str):
		data = {
			"imageUrl": image_url
		}
		return requests.put(
